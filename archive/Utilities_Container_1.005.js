...
var beginScriptMsg = ["!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!",
"******************************************************************************",
// "`7MM\"\"\"Yp, `7MM\"\"\"YMM    .g8\"\"\"bgd `7MMF'`7MN.   `7MF'     .M\"\"\"bgd   .g8\"\"\"bgd `7MM\"\"\"Mq.  `7MMF'`7MM\"\"\"Mq. MMP\"\"MM\"\"YMM",
// "  MM    Yb   MM    `7  .dP'     `M   MM    MMN.    M      ,MI    \"Y .dP'     `M   MM   `MM.   MM    MM   `MM.P'   MM   `7",
// "  MM    dP   MM   d    dM'       `   MM    M YMb   M      `MMb.     dM'       `   MM   ,M9    MM    MM   ,M9      MM     ",
// "  MM\"\"\"bg.   MMmmMM    MM            MM    M  `MN. M        `YMMNq. MM            MMmmdM9     MM    MMmmdM9       MM     ",
// "  MM    `Y   MM   Y  , MM.    `7MMF' MM    M   `MM.M      .     `MM MM.           MM  YM.     MM    MM            MM     ",
// "  MM    ,9   MM     ,M `Mb.     MM   MM    M     YMM      Mb     dM `Mb.     ,'   MM   `Mb.   MM    MM            MM     ",
// ".JMMmmmd9  .JMMmmmmMMM   `\"bmmmdPY .JMML..JML.    YM      P\"Ybmmd\"    `\"bmmmd'  .JMML. .JMM..JMML..JMML.        .JMML.   ",
