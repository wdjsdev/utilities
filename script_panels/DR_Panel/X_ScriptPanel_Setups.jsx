...
//===================================================================================================================================== Init / OBJECTS ==================================//
    ...
    if($.os.match('Windows')){
        //PC
        networkScriptPath = "//AD4/Customization/Library/Scripts/";
    } else {
        // MAC
        networkScriptPath = "/Volumes/CustomizationDR/Library/Scripts/"
        
    }
    SCRIPTFOLDERS = [
        {name: "Setup Scripts", folderPath: networkScriptPath + "setup_scripts/", square: "square_none", notes: ""},
    ]
    FAVORITES = [];
...
//===================================== UI Palette ================================================================================================//
    function miniTab(){
        var title = (SETTINGS.windowGraphics) ? '' : 'Setup Scripts' ;
    ...
    function paletteWindow(){
        ...
        var w = new Window(windowType, 'Setup Scripts', undefined, {closeButton: true});
